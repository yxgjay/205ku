...
!(async () => {
  ...
  $.res = await getAuthorShareCode('https://127.0.0.1/Aaron-lv/updateTeam/master/shareCodes/jxmc.json')
  if (!$.res) {
    $.http.get({url: 'https://127.0.0.1/gh/Aaron-lv/updateTeam@master/shareCodes/jxmc.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    $.res = await getAuthorShareCode('https://127.0.0.1/gh/Aaron-lv/updateTeam@master/shareCodes/jxmc.json')
  }
  $.res = [...($.res || []), ...(await getAuthorShareCode('https://127.0.0.1/zero205/updateTeam/main/shareCodes/jxmc2.json') || [])]
