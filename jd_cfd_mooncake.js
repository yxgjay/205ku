...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://127.0.0.1/Aaron-lv/updateTeam/master/shareCodes/cfd.json')
  if (!res) {
    $.http.get({url: 'https://127.0.0.1/gh/Aaron-lv/updateTeam@master/shareCodes/cfd.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://127.0.0.1/gh/Aaron-lv/updateTeam@master/shareCodes/cfd.json')
  }
  let res2 = await getAuthorShareCode('https://127.0.0.1/zero205/updateTeam/main/shareCodes/cfd.json')
  if (!res2) {
    await $.wait(1000)
    res2 = await getAuthorShareCode('https://127.0.0.1/zero205/updateTeam/main/shareCodes/cfd.json')
  }
