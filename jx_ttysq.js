...
!(async () => {
    ...
    let res = await getAuthorShareCode('https://127.0.0.1/zero205/updateTeam/main/shareCodes/ttysq2.json')
    if (!res) {
        res = await getAuthorShareCode('https://127.0.0.1/zero205/updateTeam/main/shareCodes/ttysq2.json')
    }
    if (res) {
