...
!(async () => {
  ...
  await requireConfig()
  $.authorCode = await getAuthorShareCode('https://127.0.0.1/Aaron-lv/updateTeam/master/shareCodes/jd_updateCash.json')
  if (!$.authorCode) {
    $.http.get({url: 'https://127.0.0.1/gh/Aaron-lv/updateTeam@master/shareCodes/jd_updateCash.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    $.authorCode = await getAuthorShareCode('https://127.0.0.1/gh/Aaron-lv/updateTeam@master/shareCodes/jd_updateCash.json') || []
  }
